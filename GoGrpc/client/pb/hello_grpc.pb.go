...
type GreeterClient interface {
	...
	LotsOfGreetingsAndReplies(ctx context.Context, opts ...grpc.CallOption) (Greeter_LotsOfGreetingsAndRepliesClient, error)
}
...
func (c *greeterClient) LotsOfGreetingsAndReplies(ctx context.Context, opts ...grpc.CallOption) (Greeter_LotsOfGreetingsAndRepliesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[2], "/pb.Greeter/LotsOfGreetingsAndReplies", opts...)
	if err != nil {
		return nil, err
	}
	x := &greeterLotsOfGreetingsAndRepliesClient{stream}
	return x, nil
}

type Greeter_LotsOfGreetingsAndRepliesClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greeterLotsOfGreetingsAndRepliesClient struct {
	grpc.ClientStream
}

func (x *greeterLotsOfGreetingsAndRepliesClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterLotsOfGreetingsAndRepliesClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreeterServer interface {
	...
	LotsOfGreetingsAndReplies(Greeter_LotsOfGreetingsAndRepliesServer) error
...
func (UnimplementedGreeterServer) LotsOfGreetingsAndReplies(Greeter_LotsOfGreetingsAndRepliesServer) error {
	return status.Errorf(codes.Unimplemented, "method LotsOfGreetingsAndReplies not implemented")
}
...
func _Greeter_LotsOfGreetingsAndReplies_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).LotsOfGreetingsAndReplies(&greeterLotsOfGreetingsAndRepliesServer{stream})
}

type Greeter_LotsOfGreetingsAndRepliesServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greeterLotsOfGreetingsAndRepliesServer struct {
	grpc.ServerStream
}

func (x *greeterLotsOfGreetingsAndRepliesServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterLotsOfGreetingsAndRepliesServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "LotsOfGreetingsAndReplies",
			Handler:       _Greeter_LotsOfGreetingsAndReplies_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
